...
Logos, OG images, embed snippets, brand guidelines. Everything a partner, journalist, or customer needs to use the LIQAA brand correctly — without emailing us.
...
Brand assets (logos, wordmarks): see [`brand-kit/TRADEMARK.md`](./brand-kit/TRADEMARK.md).
Documentation: [CC-BY-4.0](./LICENSE-DOCS) — credit "LIQAA" with a link to https://liqaa.io.

## Reporting misuse

Saw someone using the LIQAA brand in a way that's misleading? Email [partners@tkawen.com](mailto:partners@tkawen.com).
